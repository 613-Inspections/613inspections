...
const GoogleReviews = lazy(() =>
  import("./components/GoogleReviws").then((module) => ({
...
const InspectionComponentsSection = lazy(() =>
  import("./components/InspectionComponentsSection").then((module) => ({
    default: module.InspectionComponentsSection,
  }))
);
